...
export function DemoControls() {
  ...
  return (
    ...
    >
      <p className="text-[11px] uppercase tracking-[0.08em] text-[#9a9a9a]">Demo</p>
      <p className="mt-2 leading-snug text-[#5f5f5f]">
        Reset state between takes. Approve Patch without scrolling.
      </p>
      <div className="mt-3 flex flex-col gap-2">
        ...
        <div className="flex gap-2">
          <button
            type="button"
            className="nave-float nave-rise flex-1 rounded-[4px] border border-[#d4d0c8] px-2 py-1.5 text-[12px] hover:bg-[#ebebeb]"
